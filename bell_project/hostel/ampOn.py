...
#bell_out = 37 #pin 37 for relay output
...
GPIO.output(amp_out,True) #setting amp relay out to high

if __name__ == '__main__':
	# Turn on Amplifier
	GPIO.output(amp_out,True) #setting amp relay out to high - switch ON
